//! References in the implementation details come from the OpenGL ES 3.0 specification. The
...
impl ContextHandle {
    pub(crate) fn new(webgl: GLContext) -> Self {
        Self {
            inner: Rc::new(RefCell::new(ContextInner::new(webgl))),
        }
    }
}
...
impl fmt::Pointer for ContextHandle {
...
thread_local! {
    static CURRENT_CONTEXT: RefCell<Option<ContextHandle>> = RefCell::new(None);
}
...
pub(crate) fn is_current(context: Option<&ContextHandle>) -> bool {
...
pub(crate) fn make_current(context: Option<ContextHandle>) {
...
#[unwind_aborts]
pub(crate) extern "system" fn active_texture(texture: GLenum) -> () {
    with_context(|cx| cx.webgl.active_texture(texture))
}

#[unwind_aborts]
pub(crate) extern "system" fn attach_shader(program: GLuint, shader: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn begin_query(target: GLenum, id: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn begin_transform_feedback(primitive_mode: GLenum) -> () {
    with_context(|cx| cx.webgl.begin_transform_feedback(primitive_mode))
}

#[unwind_aborts]
pub(crate) extern "system" fn bind_attrib_location(
    program: GLuint,
    index: GLuint,
    name: *const GLchar,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_buffer(target: GLenum, buffer: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_buffer_base(
    target: GLenum,
    index: GLuint,
    buffer: GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_buffer_range(
    target: GLenum,
    index: GLuint,
    buffer: GLuint,
    offset: GLintptr,
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_framebuffer(target: GLenum, framebuffer: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_renderbuffer(target: GLenum, renderbuffer: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_sampler(unit: GLuint, sampler: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_texture(target: GLenum, texture: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_transform_feedback(target: GLenum, id: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn bind_vertex_array(array: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn blend_color(
    red: GLfloat,
    green: GLfloat,
    blue: GLfloat,
    alpha: GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn blend_equation(mode: GLenum) -> () {
    with_context(|cx| cx.webgl.blend_equation(mode))
}

#[unwind_aborts]
pub(crate) extern "system" fn blend_equation_separate(mode_rgb: GLenum, mode_alpha: GLenum) -> () {
    with_context(|cx| cx.webgl.blend_equation_separate(mode_rgb, mode_alpha))
}

#[unwind_aborts]
pub(crate) extern "system" fn blend_func(sfactor: GLenum, dfactor: GLenum) -> () {
    with_context(|cx| cx.webgl.blend_func(sfactor, dfactor))
}

#[unwind_aborts]
pub(crate) extern "system" fn blend_func_separate(
    sfactor_rgb: GLenum,
    dfactor_rgb: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn blit_framebuffer(
    src_x0: GLint,
    src_y0: GLint,
    src_x1: GLint,
    src_y1: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn buffer_data(
    target: GLenum,
    size: GLsizeiptr,
    data: *const c_void,
    usage: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn buffer_sub_data(
    target: GLenum,
    offset: GLintptr,
    size: GLsizeiptr,
    data: *const c_void,
...
#[unwind_aborts]
pub(crate) extern "system" fn check_framebuffer_status(target: GLenum) -> GLenum {
    with_context(|cx| cx.webgl.check_framebuffer_status(target))
}

#[unwind_aborts]
pub(crate) extern "system" fn clear(mask: GLbitfield) -> () {
    with_context(|cx| cx.webgl.clear(mask))
}

#[unwind_aborts]
pub(crate) extern "system" fn clear_bufferfi(
    buffer: GLenum,
    drawbuffer: GLint,
    depth: GLfloat,
    stencil: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn clear_bufferfv(
    buffer: GLenum,
    drawbuffer: GLint,
    value: *const GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn clear_bufferiv(
    buffer: GLenum,
    drawbuffer: GLint,
    value: *const GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn clear_bufferuiv(
    buffer: GLenum,
    drawbuffer: GLint,
    value: *const GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn clear_color(
    red: GLfloat,
    green: GLfloat,
    blue: GLfloat,
    alpha: GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn clear_depthf(d: GLfloat) -> () {
    with_context(|cx| cx.webgl.clear_depth(d))
}

#[unwind_aborts]
pub(crate) extern "system" fn clear_stencil(s: GLint) -> () {
    with_context(|cx| cx.webgl.clear_stencil(s))
}

#[unwind_aborts]
pub(crate) extern "system" fn client_wait_sync(
    sync: GLsync,
    flags: GLbitfield,
    timeout: GLuint64,
) -> GLenum {
...
#[unwind_aborts]
pub(crate) extern "system" fn color_mask(
    red: GLboolean,
    green: GLboolean,
    blue: GLboolean,
    alpha: GLboolean,
...
#[unwind_aborts]
pub(crate) extern "system" fn compile_shader(shader: GLuint) -> () {
    try_with_context((), |cx| {
        let shader = cx.shaders.get(shader)?.as_shader()?;
...
#[unwind_aborts]
pub(crate) extern "system" fn compressed_tex_image2_d(
    target: GLenum,
    level: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn compressed_tex_image3_d(
    target: GLenum,
    level: GLint,
    internalformat: GLenum,
    width: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn compressed_tex_sub_image2_d(
    target: GLenum,
    level: GLint,
    xoffset: GLint,
    yoffset: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn compressed_tex_sub_image3_d(
    target: GLenum,
    level: GLint,
    xoffset: GLint,
    yoffset: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn copy_buffer_sub_data(
    read_target: GLenum,
    write_target: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn copy_tex_image2_d(
    target: GLenum,
    level: GLint,
    internalformat: GLenum,
    x: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn copy_tex_sub_image2_d(
    target: GLenum,
    level: GLint,
    xoffset: GLint,
    yoffset: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn copy_tex_sub_image3_d(
    target: GLenum,
    level: GLint,
    xoffset: GLint,
    yoffset: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn create_program() -> GLuint {
    with_context(|cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn create_shader(type_: GLenum) -> GLuint {
    with_context(|cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn cull_face(mode: GLenum) -> () {
    with_context(|cx| cx.webgl.cull_face(mode))
}

#[unwind_aborts]
pub(crate) extern "system" fn delete_buffers(n: GLsizei, buffers: *const GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_framebuffers(n: GLsizei, framebuffers: *const GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_program(program: GLuint) -> () {
    try_with_context((), |cx| {
        let program = cx
            .shaders
            .remove(program)?
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_queries(n: GLsizei, ids: *const GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_renderbuffers(n: GLsizei, renderbuffers: *const GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_samplers(count: GLsizei, samplers: *const GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_shader(shader: GLuint) -> () {
    try_with_context((), |cx| {
        let shader = cx
            .shaders
            .remove(shader)?
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_sync(sync: GLsync) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_textures(n: GLsizei, textures: *const GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_transform_feedbacks(n: GLsizei, ids: *const GLuint) -> () {
    let ids = user_array(n, ids);
    with_context(|cx| {
        for &id in ids {
...
#[unwind_aborts]
pub(crate) extern "system" fn delete_vertex_arrays(n: GLsizei, arrays: *const GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn depth_func(func: GLenum) -> () {
    with_context(|cx| cx.webgl.depth_func(func))
}

#[unwind_aborts]
pub(crate) extern "system" fn depth_mask(flag: GLboolean) -> () {
    let flag = webgl_boolean(flag);
    with_context(|cx| cx.webgl.depth_mask(flag))
}

#[unwind_aborts]
pub(crate) extern "system" fn depth_rangef(n: GLfloat, f: GLfloat) -> () {
    with_context(|cx| cx.webgl.depth_range(n, f))
}

#[unwind_aborts]
pub(crate) extern "system" fn detach_shader(program: GLuint, shader: GLuint) -> () {
    try_with_context((), |cx| {
        let program = cx.shaders.get(program)?.as_program()?;
        let shader = cx.shaders.get(shader)?.as_shader()?;
...
#[unwind_aborts]
pub(crate) extern "system" fn disable(cap: GLenum) -> () {
    with_context(|cx| cx.webgl.disable(cap))
}

#[unwind_aborts]
pub(crate) extern "system" fn disable_vertex_attrib_array(index: GLuint) -> () {
    with_context(|cx| cx.webgl.disable_vertex_attrib_array(index))
}

#[unwind_aborts]
pub(crate) extern "system" fn draw_arrays(mode: GLenum, first: GLint, count: GLsizei) -> () {
    with_context(|cx| cx.webgl.draw_arrays(mode, first, count))
}

#[unwind_aborts]
pub(crate) extern "system" fn draw_arrays_instanced(
    mode: GLenum,
    first: GLint,
    count: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn draw_buffers(n: GLsizei, bufs: *const GLenum) -> () {
    let bufs = user_array(n, bufs);
    with_context(|cx| cx.webgl.draw_buffers(bufs))
}

#[unwind_aborts]
pub(crate) extern "system" fn draw_elements(
    mode: GLenum,
    count: GLsizei,
    type_: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn draw_elements_instanced(
    mode: GLenum,
    count: GLsizei,
    type_: GLenum,
    indices: *const c_void,
...
#[unwind_aborts]
pub(crate) extern "system" fn draw_range_elements(
    mode: GLenum,
    start: GLuint,
    end: GLuint,
    count: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn enable(cap: GLenum) -> () {
    with_context(|cx| cx.webgl.enable(cap))
}

#[unwind_aborts]
pub(crate) extern "system" fn enable_vertex_attrib_array(index: GLuint) -> () {
    with_context(|cx| cx.webgl.enable_vertex_attrib_array(index))
}

#[unwind_aborts]
pub(crate) extern "system" fn end_query(target: GLenum) -> () {
    with_context(|cx| cx.webgl.end_query(target))
}

#[unwind_aborts]
pub(crate) extern "system" fn end_transform_feedback() -> () {
    with_context(|cx| cx.webgl.end_transform_feedback())
}

#[unwind_aborts]
pub(crate) extern "system" fn fence_sync(condition: GLenum, flags: GLbitfield) -> GLsync {
    with_context(|cx| cx.syncs.add(cx.webgl.fence_sync(condition, flags)) as GLsync)
}

#[unwind_aborts]
pub(crate) extern "system" fn finish() -> () {
    with_context(|cx| cx.webgl.finish())
}

#[unwind_aborts]
pub(crate) extern "system" fn flush() -> () {
    with_context(|cx| cx.webgl.flush())
}

#[unwind_aborts]
pub(crate) extern "system" fn flush_mapped_buffer_range(
    _target: GLenum,
    _offset: GLintptr,
    _length: GLsizeiptr,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn framebuffer_renderbuffer(
    target: GLenum,
    attachment: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn framebuffer_texture2_d(
    target: GLenum,
    attachment: GLenum,
    textarget: GLenum,
    texture: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn framebuffer_texture_layer(
    target: GLenum,
    attachment: GLenum,
    texture: GLuint,
    level: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn front_face(mode: GLenum) -> () {
    with_context(|cx| cx.webgl.front_face(mode))
}

#[unwind_aborts]
pub(crate) extern "system" fn gen_buffers(n: GLsizei, buffers: *mut GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn gen_framebuffers(n: GLsizei, framebuffers: *mut GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn gen_queries(n: GLsizei, ids: *mut GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn gen_renderbuffers(n: GLsizei, renderbuffers: *mut GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn gen_samplers(count: GLsizei, samplers: *mut GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn gen_textures(n: GLsizei, textures: *mut GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn gen_transform_feedbacks(n: GLsizei, ids: *mut GLuint) -> () {
    let ids = user_array_mut(n, ids);
    with_context(|cx| {
        for id in ids {
            *id = cx
...
#[unwind_aborts]
pub(crate) extern "system" fn gen_vertex_arrays(n: GLsizei, arrays: *mut GLuint) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn generate_mipmap(target: GLenum) -> () {
    with_context(|cx| cx.webgl.generate_mipmap(target))
}

#[unwind_aborts]
pub(crate) extern "system" fn get_active_attrib(
    program: GLuint,
    index: GLuint,
    buf_size: GLsizei,
    length: *mut GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_active_uniform(
    program: GLuint,
    index: GLuint,
    buf_size: GLsizei,
    length: *mut GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_active_uniform_block_name(
    program: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_active_uniform_blockiv(
    program: GLuint,
    uniform_block_index: GLuint,
    pname: GLenum,
    params: *mut GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_active_uniformsiv(
    program: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_attached_shaders(
    program: GLuint,
    max_count: GLsizei,
    count: *mut GLsizei,
    shaders: *mut GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_attrib_location(program: GLuint, name: *const GLchar) -> GLint {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_booleanv(pname: GLenum, data: *mut GLboolean) -> () {
    with_context(|cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_buffer_parameteri64v(
    target: GLenum,
    pname: GLenum,
    params: *mut GLint64,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_buffer_parameteriv(
    target: GLenum,
    pname: GLenum,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_buffer_pointerv(
    _target: GLenum,
    _pname: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_error() -> GLenum {
    with_context(|cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_floatv(pname: GLenum, data: *mut GLfloat) -> () {
    with_context(|cx| {
        let value = cx.webgl.get_parameter(pname);
        unpack_parameter(cx, pname, data, value);
    })
...
#[unwind_aborts]
pub(crate) extern "system" fn get_frag_data_location(
    program: GLuint,
    name: *const GLchar,
) -> GLint {
    try_with_context(-1, |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_framebuffer_attachment_parameteriv(
    target: GLenum,
    attachment: GLenum,
    pname: GLenum,
    params: *mut GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_integer64i_v(
    target: GLenum,
    index: GLuint,
    data: *mut GLint64,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_integer64v(pname: GLenum, data: *mut GLint64) -> () {
    with_context(|cx| {
        let value = cx.webgl.get_parameter(pname);
        unpack_parameter(cx, pname, data, value);
    })
...
#[unwind_aborts]
pub(crate) extern "system" fn get_integeri_v(
    target: GLenum,
    index: GLuint,
    data: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_integerv(pname: GLenum, data: *mut GLint) -> () {
    with_context(|cx| {
        let value = cx.webgl.get_parameter(pname);
        unpack_parameter(cx, pname, data, value);
    })
...
#[unwind_aborts]
pub(crate) extern "system" fn get_internalformativ(
    target: GLenum,
    internalformat: GLenum,
    pname: GLenum,
    buf_size: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_program_binary(
    _program: GLuint,
    _buf_size: GLsizei,
    _length: *mut GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_program_info_log(
    program: GLuint,
    buf_size: GLsizei,
    length: *mut GLsizei,
    info_log: *mut GLchar,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_programiv(
    program: GLuint,
    pname: GLenum,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_query_objectuiv(
    id: GLuint,
    pname: GLenum,
    params: *mut GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_queryiv(target: GLenum, pname: GLenum, params: *mut GLint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_renderbuffer_parameteriv(
    target: GLenum,
    pname: GLenum,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_sampler_parameterfv(
    sampler: GLuint,
    pname: GLenum,
    params: *mut GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_sampler_parameteriv(
    sampler: GLuint,
    pname: GLenum,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_shader_info_log(
    shader: GLuint,
    buf_size: GLsizei,
    length: *mut GLsizei,
    info_log: *mut GLchar,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_shader_precision_format(
    shadertype: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_shader_source(
    shader: GLuint,
    buf_size: GLsizei,
    length: *mut GLsizei,
    source: *mut GLchar,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_shaderiv(
    shader: GLuint,
    pname: GLenum,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_string(name: GLenum) -> *const GLubyte {
    with_context(|cx| cache_string(cx.webgl.get_parameter(name)))
}

#[unwind_aborts]
pub(crate) extern "system" fn get_stringi(name: GLenum, index: GLuint) -> *const GLubyte {
    with_context(|cx| cache_string(cx.webgl.get_indexed_parameter(name, index)))
}

#[unwind_aborts]
pub(crate) extern "system" fn get_synciv(
    sync: GLsync,
    pname: GLenum,
    buf_size: GLsizei,
    length: *mut GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_tex_parameterfv(
    target: GLenum,
    pname: GLenum,
    params: *mut GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_tex_parameteriv(
    target: GLenum,
    pname: GLenum,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_transform_feedback_varying(
    program: GLuint,
    index: GLuint,
    buf_size: GLsizei,
    length: *mut GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_uniform_block_index(
    program: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_uniform_indices(
    program: GLuint,
    uniform_count: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_uniform_location(program: GLuint, name: *const GLchar) -> GLint {
    try_with_context(-1, |cx| {
        let program = cx.shaders.get(program)?.as_program()?;
        let name = user_str(name)?;
        Ok(cx
...
#[unwind_aborts]
pub(crate) extern "system" fn get_uniformfv(
    program: GLuint,
    location: GLint,
    params: *mut GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_uniformiv(
    program: GLuint,
    location: GLint,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_uniformuiv(
    program: GLuint,
    location: GLint,
    params: *mut GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_vertex_attrib_iiv(
    index: GLuint,
    pname: GLenum,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_vertex_attrib_iuiv(
    index: GLuint,
    pname: GLenum,
    params: *mut GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_vertex_attrib_pointerv(
    _index: GLuint,
    _pname: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn get_vertex_attribfv(
    index: GLuint,
    pname: GLenum,
    params: *mut GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn get_vertex_attribiv(
    index: GLuint,
    pname: GLenum,
    params: *mut GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn hint(target: GLenum, mode: GLenum) -> () {
    with_context(|cx| cx.webgl.hint(target, mode))
}

#[unwind_aborts]
pub(crate) extern "system" fn invalidate_framebuffer(
    target: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn invalidate_sub_framebuffer(
    target: GLenum,
    num_attachments: GLsizei,
    attachments: *const GLenum,
    x: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn is_buffer(buffer: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.buffers
            .get_nullable(buffer)
...
#[unwind_aborts]
pub(crate) extern "system" fn is_enabled(cap: GLenum) -> GLboolean {
    with_context(|cx| gl_boolean(cx.webgl.is_enabled(cap)))
}

#[unwind_aborts]
pub(crate) extern "system" fn is_framebuffer(framebuffer: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.framebuffers
...
#[unwind_aborts]
pub(crate) extern "system" fn is_program(program: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.shaders
...
#[unwind_aborts]
pub(crate) extern "system" fn is_query(id: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.queries
            .get_nullable(id)
...
#[unwind_aborts]
pub(crate) extern "system" fn is_renderbuffer(renderbuffer: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.renderbuffers
...
#[unwind_aborts]
pub(crate) extern "system" fn is_sampler(sampler: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.samplers
...
#[unwind_aborts]
pub(crate) extern "system" fn is_shader(shader: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.shaders
            .get_nullable(shader)
...
#[unwind_aborts]
pub(crate) extern "system" fn is_sync(sync: GLsync) -> GLboolean {
    with_context(|cx| {
        cx.syncs
...
#[unwind_aborts]
pub(crate) extern "system" fn is_texture(texture: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.textures
...
#[unwind_aborts]
pub(crate) extern "system" fn is_transform_feedback(id: GLuint) -> GLboolean {
    with_context(|cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn is_vertex_array(array: GLuint) -> GLboolean {
    with_context(|cx| {
        cx.vertex_arrays
            .get_nullable(array)
...
#[unwind_aborts]
pub(crate) extern "system" fn line_width(width: GLfloat) -> () {
    with_context(|cx| cx.webgl.line_width(width))
}

#[unwind_aborts]
pub(crate) extern "system" fn link_program(program: GLuint) -> () {
    try_with_context((), |cx| {
        let program = cx.shaders.get(program)?.as_program()?;
...
#[unwind_aborts]
pub(crate) extern "system" fn map_buffer_range(
    _target: GLenum,
    _offset: GLintptr,
    _length: GLsizeiptr,
    _access: GLbitfield,
...
#[unwind_aborts]
pub(crate) extern "system" fn pause_transform_feedback() -> () {
    with_context(|cx| cx.webgl.pause_transform_feedback())
}

#[unwind_aborts]
pub(crate) extern "system" fn pixel_storei(pname: GLenum, param: GLint) -> () {
    with_context(|cx| cx.webgl.pixel_storei(pname, param))
}

#[unwind_aborts]
pub(crate) extern "system" fn polygon_offset(factor: GLfloat, units: GLfloat) -> () {
    with_context(|cx| cx.webgl.polygon_offset(factor, units))
}

#[unwind_aborts]
pub(crate) extern "system" fn program_binary(
    _program: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn program_parameteri(
    _program: GLuint,
    _pname: GLenum,
    _value: GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn read_buffer(src: GLenum) -> () {
    with_context(|cx| cx.webgl.read_buffer(src))
}

#[unwind_aborts]
pub(crate) extern "system" fn read_pixels(
    x: GLint,
    y: GLint,
    width: GLsizei,
    height: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn release_shader_compiler() -> () {
    unimplemented!("shader binaries are not supported")
}

#[unwind_aborts]
pub(crate) extern "system" fn renderbuffer_storage(
    target: GLenum,
    internalformat: GLenum,
    width: GLsizei,
    height: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn renderbuffer_storage_multisample(
    target: GLenum,
    samples: GLsizei,
    internalformat: GLenum,
    width: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn resume_transform_feedback() -> () {
    with_context(|cx| cx.webgl.resume_transform_feedback())
}

#[unwind_aborts]
pub(crate) extern "system" fn sample_coverage(value: GLfloat, invert: GLboolean) -> () {
    let invert = webgl_boolean(invert);
    with_context(|cx| cx.webgl.sample_coverage(value, invert))
}

#[unwind_aborts]
pub(crate) extern "system" fn sampler_parameterf(
    sampler: GLuint,
    pname: GLenum,
    param: GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn sampler_parameterfv(
    sampler: GLuint,
    pname: GLenum,
    param: *const GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn sampler_parameteri(
    sampler: GLuint,
    pname: GLenum,
    param: GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn sampler_parameteriv(
    sampler: GLuint,
    pname: GLenum,
    param: *const GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn scissor(x: GLint, y: GLint, width: GLsizei, height: GLsizei) -> () {
    with_context(|cx| cx.webgl.scissor(x, y, width, height))
}

#[unwind_aborts]
pub(crate) extern "system" fn shader_binary(
    _count: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn shader_source(
    shader: GLuint,
    count: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn stencil_func(func: GLenum, ref_: GLint, mask: GLuint) -> () {
    with_context(|cx| cx.webgl.stencil_func(func, ref_, mask))
}

#[unwind_aborts]
pub(crate) extern "system" fn stencil_func_separate(
    face: GLenum,
    func: GLenum,
    ref_: GLint,
    mask: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn stencil_mask(mask: GLuint) -> () {
    with_context(|cx| cx.webgl.stencil_mask(mask))
}

#[unwind_aborts]
pub(crate) extern "system" fn stencil_mask_separate(face: GLenum, mask: GLuint) -> () {
    with_context(|cx| cx.webgl.stencil_mask_separate(face, mask))
}

#[unwind_aborts]
pub(crate) extern "system" fn stencil_op(fail: GLenum, zfail: GLenum, zpass: GLenum) -> () {
    with_context(|cx| cx.webgl.stencil_op(fail, zfail, zpass))
}

#[unwind_aborts]
pub(crate) extern "system" fn stencil_op_separate(
    face: GLenum,
    sfail: GLenum,
    dpfail: GLenum,
    dppass: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn tex_image2_d(
    target: GLenum,
    level: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn tex_image3_d(
    target: GLenum,
    level: GLint,
    internalformat: GLint,
    width: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn tex_parameterf(target: GLenum, pname: GLenum, param: GLfloat) -> () {
    with_context(|cx| cx.webgl.tex_parameterf(target, pname, param))
}

#[unwind_aborts]
pub(crate) extern "system" fn tex_parameterfv(
    target: GLenum,
    pname: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn tex_parameteri(target: GLenum, pname: GLenum, param: GLint) -> () {
    with_context(|cx| cx.webgl.tex_parameteri(target, pname, param))
}

#[unwind_aborts]
pub(crate) extern "system" fn tex_parameteriv(
    target: GLenum,
    pname: GLenum,
    params: *const GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn tex_storage2_d(
    target: GLenum,
    levels: GLsizei,
    internalformat: GLenum,
    width: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn tex_storage3_d(
    target: GLenum,
    levels: GLsizei,
    internalformat: GLenum,
    width: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn tex_sub_image2_d(
    target: GLenum,
    level: GLint,
    xoffset: GLint,
    yoffset: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn tex_sub_image3_d(
    target: GLenum,
    level: GLint,
    xoffset: GLint,
    yoffset: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn transform_feedback_varyings(
    program: GLuint,
    count: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform1f(location: GLint, v0: GLfloat) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform1fv(
    location: GLint,
    count: GLsizei,
    value: *const GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform1i(location: GLint, v0: GLint) -> () {
    try_with_context((), |cx| {
        let location = cx.uniforms.get_active_obj_nullable(location)?;
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform1iv(
    location: GLint,
    count: GLsizei,
    value: *const GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform1ui(location: GLint, v0: GLuint) -> () {
    try_with_context((), |cx| {
        let location = cx.uniforms.get_active_obj_nullable(location)?;
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform1uiv(
    location: GLint,
    count: GLsizei,
    value: *const GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform2f(location: GLint, v0: GLfloat, v1: GLfloat) -> () {
    try_with_context((), |cx| {
        let location = cx.uniforms.get_active_obj_nullable(location)?;
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform2fv(
    location: GLint,
    count: GLsizei,
    value: *const GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform2i(location: GLint, v0: GLint, v1: GLint) -> () {
    try_with_context((), |cx| {
        let location = cx.uniforms.get_active_obj_nullable(location)?;
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform2iv(
    location: GLint,
    count: GLsizei,
    value: *const GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform2ui(location: GLint, v0: GLuint, v1: GLuint) -> () {
    try_with_context((), |cx| {
        let location = cx.uniforms.get_active_obj_nullable(location)?;
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform2uiv(
    location: GLint,
    count: GLsizei,
    value: *const GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform3f(
    location: GLint,
    v0: GLfloat,
    v1: GLfloat,
    v2: GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform3fv(
    location: GLint,
    count: GLsizei,
    value: *const GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform3i(location: GLint, v0: GLint, v1: GLint, v2: GLint) -> () {
    try_with_context((), |cx| {
        let location = cx.uniforms.get_active_obj_nullable(location)?;
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform3iv(
    location: GLint,
    count: GLsizei,
    value: *const GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform3ui(
    location: GLint,
    v0: GLuint,
    v1: GLuint,
    v2: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform3uiv(
    location: GLint,
    count: GLsizei,
    value: *const GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform4f(
    location: GLint,
    v0: GLfloat,
    v1: GLfloat,
    v2: GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform4fv(
    location: GLint,
    count: GLsizei,
    value: *const GLfloat,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform4i(
    location: GLint,
    v0: GLint,
    v1: GLint,
    v2: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform4iv(
    location: GLint,
    count: GLsizei,
    value: *const GLint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform4ui(
    location: GLint,
    v0: GLuint,
    v1: GLuint,
    v2: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform4uiv(
    location: GLint,
    count: GLsizei,
    value: *const GLuint,
) -> () {
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_block_binding(
    program: GLuint,
    uniform_block_index: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix2fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix2x3fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix2x4fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix3fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix3x2fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix3x4fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix4fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix4x2fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn uniform_matrix4x3fv(
    location: GLint,
    count: GLsizei,
    transpose: GLboolean,
    value: *const GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn unmap_buffer(_target: GLenum) -> GLboolean {
    unimplemented!("client-side buffers are not fully supported");
}

#[unwind_aborts]
pub(crate) extern "system" fn use_program(program: GLuint) -> () {
    try_with_context((), |cx| {
...
#[unwind_aborts]
pub(crate) extern "system" fn validate_program(program: GLuint) -> () {
    try_with_context((), |cx| {
        let program = cx.shaders.get(program)?.as_program()?;
...
#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib1f(index: GLuint, x: GLfloat) -> () {
    with_context(|cx| cx.webgl.vertex_attrib1f(index, x))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib1fv(index: GLuint, v: *const GLfloat) -> () {
    let v = user_array(1, v);
    with_context(|cx| cx.webgl.vertex_attrib1fv(index, v))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib2f(index: GLuint, x: GLfloat, y: GLfloat) -> () {
    with_context(|cx| cx.webgl.vertex_attrib2f(index, x, y))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib2fv(index: GLuint, v: *const GLfloat) -> () {
    let v = user_array(2, v);
    with_context(|cx| cx.webgl.vertex_attrib2fv(index, v))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib3f(
    index: GLuint,
    x: GLfloat,
    y: GLfloat,
    z: GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib3fv(index: GLuint, v: *const GLfloat) -> () {
    let v = user_array(3, v);
    with_context(|cx| cx.webgl.vertex_attrib3fv(index, v))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib4f(
    index: GLuint,
    x: GLfloat,
    y: GLfloat,
    z: GLfloat,
...
#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib4fv(index: GLuint, v: *const GLfloat) -> () {
    let v = user_array(4, v);
    with_context(|cx| cx.webgl.vertex_attrib4fv(index, v))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib_divisor(index: GLuint, divisor: GLuint) -> () {
    with_context(|cx| cx.webgl.vertex_attrib_divisor(index, divisor))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib_i4i(
    index: GLuint,
    x: GLint,
    y: GLint,
    z: GLint,
...
#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib_i4iv(index: GLuint, v: *const GLint) -> () {
    let v = user_array(4, v);
    with_context(|cx| cx.webgl.vertex_attrib_i4iv(index, v))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib_i4ui(
    index: GLuint,
    x: GLuint,
    y: GLuint,
    z: GLuint,
...
#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib_i4uiv(index: GLuint, v: *const GLuint) -> () {
    let v = user_array(4, v);
    with_context(|cx| cx.webgl.vertex_attrib_i4uiv(index, v))
}

#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib_i_pointer(
    index: GLuint,
    size: GLint,
    type_: GLenum,
    stride: GLsizei,
...
#[unwind_aborts]
pub(crate) extern "system" fn vertex_attrib_pointer(
    index: GLuint,
    size: GLint,
    type_: GLenum,
...
#[unwind_aborts]
pub(crate) extern "system" fn viewport(x: GLint, y: GLint, width: GLsizei, height: GLsizei) -> () {
    with_context(|cx| cx.webgl.viewport(x, y, width, height))
}

#[unwind_aborts]
pub(crate) extern "system" fn wait_sync(sync: GLsync, flags: GLbitfield, timeout: GLuint64) -> () {
    try_with_context((), |cx| {
        let sync = cx.syncs.get(sync as GLuint)?;
